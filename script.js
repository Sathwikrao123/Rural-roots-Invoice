...
function recalc() {
  ...
  document.getElementById('totalRs').textContent = t.rs || '';
  document.getElementById('totalPs').textContent = t.ps || '';
  document.getElementById('grandRs').textContent = t.rs || '';
  document.getElementById('grandPs').textContent = t.ps || '';
  document.getElementById('rupeesWords').textContent = total > 0 ? numberToWords(Math.round(total)) + ' Only' : '';
}
